...
i18n.use(initReactI18next).init({
  resources: {
    en: {
      ...
      update : "Update",
      visit_us : "Visit our website",
      visit_us_desc : "Explore Morocco like never before: Reviews, tips, and hidden gems just a click away!",
      users : "800+ users",
      trusted : "100% trusted",
      existence : "5+ years of existence",
      happy_users : "98% happy users",
    ...
    fr: {
      ...
      update : "Modifier",
      visit_us : "Visitez notre site",
      visit_us_desc : "Découvrez le Maroc autrement : avis, conseils et trésors cachés à portée de clic !",
      users : "800+ utilisateurs",
      trusted : "100% fiable",
      existence : "5+ ans d'existence",
      happy_users : "98% utilisateurs satisfaits",
      best_places : "Meilleures places",
